...
OBJS = $(PROG_NAME).o pinwheel.o fps_counter.o renderer.o gra_console.o console.o console_context.o math.o device_manager.o device_state.o accessory_factory.o accessory.o memory_pak.o rumble_pak.o menu_state.o menu_builder_registrar.o menu_builder_resolver.o menu_builder_table.o default_menu_builder.o default_mb_args.o mpk_menu_builder.o acc_mb_args.o menu_nav_controller.o menu_tree.o main_menu.o slot_menu.o mpk_menu.o game_menu.o
