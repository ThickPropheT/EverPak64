...
OBJS = $(PROG_NAME).o pinwheel.o fps_counter.o renderer.o gra_console.o console.o math.o device.o accessory.o menu.o menu_state.o menu_tree.o root_menu.o slot_menu.o
